...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.NumpyFolderDataset', path=data, use_labels=True, max_size=None, xflip=False)
    ...
    if diffaugment is None:
        diffaugment = 'translation' # 'color,translation,cutout'
