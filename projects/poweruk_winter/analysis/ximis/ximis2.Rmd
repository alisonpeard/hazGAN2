...
Define some simulation parameters. We wil use a Rayleigh distribution, with scale $C=10$, $r=22$ events per year over $R=16$ years, and extract the top $M=30$ values as exceedances.
...
w_parent <- optim(par_parent, nll, x = parent_data, method = "L-BFGS-B", lower = c(0.01, 0.01))$par[[1]]
