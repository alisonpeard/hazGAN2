...
from mangroves.MangroveDamage import MangroveDamageModel
...
indir_alison = os.path.join("..", "resources")
infile = os.path.join("..", "resources", 'data-from-yu_v2.csv')
...
if __name__ == "__main__":
    ...
    modelpath = os.path.join("..", 'results', 'mangroves', 'damagemodel.pkl')
    ...
    plt.tight_layout()
    fig.savefig(os.path.join("..", "results", "figures", "mangroves", "model.pdf"), transparent=True, dpi=300)
    # %%
